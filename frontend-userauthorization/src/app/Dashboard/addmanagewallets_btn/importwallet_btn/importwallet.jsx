...
//         <input type="text" placeholder="Recovery phrase or private key" className={styles.search} />
//       </div>
...
//       </div>
//       <button className={styles.importButton} onClick={() => console.log('Continue button clicked')}>
//         Import wallet
//       </button>
//     </div>
//   );
