...
// import { useRef } from 'react'; // Import useRef for detecting outside clicks
...
//       if (dropdownVisible && !document.querySelector(`.${styles.dropdown}`)?.contains(event.target)) {
//         setDropdownVisible(false);
//       }
//       if (fiatDropdownVisible && !document.querySelector(`.${styles.fiatDropdown}`)?.contains(event.target)) {
...
//           </div>
//         )}
//         {activeTab === 'Fiat' && <div>Fiat Content</div>}
...
//       )}
//       {fiatDropdownVisible && (
//         <div className={styles.fiatDropdown}>
//           <div className={styles.dropdownContent}>
//             <div style={{ color: '#fff', fontSize: '20px', fontWeight: 'bold', textAlign: 'left', marginBottom: '10px' }}>
//               Fiat
//               <hr style={{ color: 'gray' }} />
