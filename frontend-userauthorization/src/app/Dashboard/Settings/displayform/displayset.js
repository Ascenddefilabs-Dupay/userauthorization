...
const DisplaySettings = () => {
  ...
  // Redirect to currency selection screen and pass the selected currency back
  const handlecurrencyselector = () => {
    let redirectUrl = 'http://localhost:3000//Dashboard/currencyform';
    router.push(redirectUrl);
  };
      ...
      <div className="display_card">
        ...
        <div className="appearance_set">
          ...
          <div className="display_card4">
            {/* Button to select a different currency */}
