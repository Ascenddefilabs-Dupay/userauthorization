...
//         router.push(`/Crypto_Wallet/Dashboard/displayform?currency=${encodeURIComponent(currency)}`);
//         router.push('http://localhost:3000//Crypto_Wallet/Dashboard/Settings/displayform');
//     };
...
const CurrencySelector = () => {
    ...
    const handleCurrencySelect = (currency) => {
        ...
        router.push(`/Crypto_Wallet/Dashboard/Settings/displayform?currency=${encodeURIComponent(currency)}`);
    };
    ...
    const handleBackClick = () => {
        router.push('/Crypto_Wallet/Dashboard/Settings/displayform');
    };
