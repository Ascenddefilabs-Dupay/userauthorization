...
//         let redirectUrl = 'http://localhost:3000//Crypto_Wallet/Dashboard/Settings';
//         router.push(redirectUrl);
//     };

//     const securityLockButtonClick = () => {
//         let redirectUrl = 'http://localhost:3000//Crypto_Wallet/Dashboard/Settings/passwordform';
//         router.push(redirectUrl);
//     };
...
const SecurityScreen = () => {
    ...
    const securityLockButtonClick = () => {
        let redirectUrl = '/Crypto_Wallet/Dashboard/Settings/passwordform';
        router.push(redirectUrl);
    };
