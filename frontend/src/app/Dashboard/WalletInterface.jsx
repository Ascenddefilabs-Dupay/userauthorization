...
import { faPlus, faExchangeAlt, faSyncAlt, faPaperPlane, faDownload, faTimes, faWallet, faListAlt, faCog, faCopy, faBell, faExpand,faUser } from '@fortawesome/free-solid-svg-icons';
...
const WalletInterface = () => {
  ...
  const handleAddCryptoClick = () => {
    ...
    router.push('/Dashboard/crypto'); // Ensure the correct path here
  };

  const handleManageWallets = () => {
    router.push('/Dashboard/Manage'); // Adjust the route as needed
  };
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <div className={styles.rightSection}>
          ...
          <FontAwesomeIcon icon={faExpand} onClick={() => handleIconClick('Enlarge')} />
        </div>
      </div>
      ...
      {dropdownVisible && (
        <div className={styles.dropdown}>
          ...
          <div style={{ color: '#fff', fontSize: '20px', fontWeight: 'bold', textAlign: 'left', marginBottom: '10px' }}>
              Wallets
              <hr style={{ margin: '10px 0' ,color: 'gray'}} /> {/* Add vertical space around the <hr /> */}
