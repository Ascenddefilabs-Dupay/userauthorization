...
const ManageProfile = () => {
  ...
  const navigateToAddAddress= () => {
    router.push('/Dashboard/addmanagewallets_btn/addaddress_btn', '/wallet')
    // Add your navigation logic here
  };
  
  const navigateToCreateWallet = () => {
    router.push('/Dashboard/addmanagewallets_btn/createnewwallet_btn');
  };  

  const navigateToImportWallet = () => {
    router.push('/Dashboard/addmanagewallets_btn/importwallet_btn', '/wallet')
    // Add your navigation logic here
  };

  const navigateToCreateLedgerWallet = () => {
    router.push('/Dashboard/addmanagewallets_btn/connectledger_btn')
  };
